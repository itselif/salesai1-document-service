...
This event is triggered upon the creation of a `storeManagementShareToken` data object in the database. The event payload encompasses the newly created data, encapsulated within the root of the paylod.
